...
export function CompanySelector() {
  ...
  return (
    <div className="flex items-center gap-1">
      <DropdownMenu>
        <DropdownMenuTrigger className="h-9 w-[190px] md:w-[230px] flex items-center justify-between px-3 font-semibold shadow-xs rounded-md border border-input bg-background text-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none cursor-pointer">
          ...
          <ChevronDown className="h-4 w-4 text-muted-foreground shrink-0 opacity-70 ml-1" />
        </DropdownMenuTrigger>
